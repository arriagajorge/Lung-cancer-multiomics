...
* $Id: main.cpp,v 1.11 2012/08/02 18:27:32 manju Exp $ */
...
int run( int argc, char * argv[] )
{
   ...
   */
    ...
    if (p.sigma == 99 && (cmpIgnoreCase(p.algorithm.c_str(),"fixed_bandwidth")==0 || cmpIgnoreCase(p.algorithm.c_str(),"variable_bandwidth")==0)) {
  ...
  else
  {
    ...
    if (p.hub != "") {
      string hub = p.hub;
      string prefix = "_";
      if (!(hub.substr(0, prefix.size()) == prefix))
         hub = "_" + hub;
