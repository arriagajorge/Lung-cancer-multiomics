...
setwd("~/lungsquamouscells/MI/filtered/")
...
node_index=match(V(g)$name, da4$id)
V(g)$color=as.numeric(da4$logFC[node_index])

#get readable names
methy=read_tsv("/home/mdiaz/lungsquamouscells/functional_enrichment/MapMethy.tsv")
