...
stability=do.call(rbind,lapply(1:1,function(x) 
...
setwd("~/lungsquamouscells/functional_enrichment/feature_intersection")
library(UpSetR)
...
top=as.data.frame(do.call(rbind,lapply(1:1,function(x)
