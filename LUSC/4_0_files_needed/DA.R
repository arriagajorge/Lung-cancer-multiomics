setwd("~/lungsquamouscells/prepo_data")
library(limma)
library(data.table)
library(ggplot2)
...
expre=fread("/home/mdiaz/lungsquamouscells/prepo_data/multiomicsLUSC/RNAseqnormalized_lusc-normal.tsv")
...
dev.off()
setwd("/home/mdiaz/lungsquamouscells/MI/DA/")
write.table(temp,"DE.genes.tsv",sep='\t',quote=F,row.names=F)
setwd("~/lungsquamouscells/prepo_data")
#next:GSEA
#################miRNA###########################################
mir=fread("/home/mdiaz/lungsquamouscells/prepo_data/multiomicsLUSC/miRNAseqNormi_lusc-normal.tsv")
...
setwd("~/lungsquamouscells/prepo_data/multiomicsLUSC/")
methy=data.table::fread("methyM_lusc-normal.tsv")
setwd("~/lungsquamouscells/prepo_data")
